...
# Target Group - Agrupa instancias EC2 con health check en "/"
...
# Listener HTTP - Puerto 80, reenvía tráfico al target group
...
# Attachments - Registra EC2 en target group (puerto 80)
